...
const { EXPERIENCE_EXPERT, DURATION_MONTH, MOBILITY_FRANCE, SOURCE_RECOMMANDATION, WORK_MODE_REMOTE_SITE, WORK_DURATION__1_TO_6_MONTHS, AVAILABILITY_OFF, COMPANY_SIZE_LESS_10 } = require('../../server/plugins/sosynpl/consts')
